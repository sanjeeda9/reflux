...
render:function () {
    return (
      ...
      React.createElement("div", {id: "h"}, 
      React.createElement("h1", {id: "title"}, "Search a movie that you like"), 
        React.createElement("div", {className: "row form-group", id: "search"}, 
        React.createElement("div", {className: "col-sm-2"}, 
          React.createElement("button", {className: "btn btn-primary dropdown-toggle", type: "button", id: "menu1", "data-toggle": "dropdown", value: this.state.db}, 
          this.state.db, " ", React.createElement("span", {className: "caret"})), 
          React.createElement("ul", {className: "dropdown-menu", role: "menu"}, 
          React.createElement("li", {className: "dropdown-header"}, React.createElement("strong", null, "Select Search From")), 
          React.createElement("li", {className: "divider"}), 
          React.createElement("li", null, React.createElement("a", {href: "#", onClick: this.setDB}, "Local DB")), 
          React.createElement("li", null, React.createElement("a", {href: "#", onClick: this.setDB}, "OMDB"))
          )
      ), 
        ...
        React.createElement("div", {className: "col-sm-1"}, 
          ...
          "Search ", React.createElement("span", {className: "glyphicon glyphicon-search"})
          )
        )
  ...
  searchMov:function () {
    ...
    console.log("end");
    React.render(React.createElement(Load, {db: this.state.db, ml: movList}),document.getElementById("displayMov"));
    },
    setDB:function (e) {
...
module.exports = Head;
},{"./Load":201,"react":199}],201:[function(require,module,exports){
var React = require('react');
var Load=React.createClass({displayName: "Load",
  getInitialState:function () {
...
$.ajax({
   ...
   this.setState({arr:d});
    ...
    displayDB:function functionName() {
        ...
        movList.map(function(d){
         ...
         return(
           React.createElement("div", {className: "well row", key: count++}, 
            React.createElement("div", {className: "col-sm-4"}, React.createElement("img", {id: "imgs", src: d.Poster})
            ), 
            React.createElement("div", {className: "col-sm-8"}, 
              React.createElement("h2", null, " ", d.Title), React.createElement("h3", null, "Year: ", d.Year), 
              React.createElement("button", {onClick: (event)=>{self.handleAdd(d)}, className: "btn btn-info", "data-toggle": "modal", "data-target": "#myModalAdd"}, "Add to DB")
            ), 

            React.createElement("div", {className: "modal fade", id: "myModalAdd", role: "dialog", "aria-labelledby": "myModalLabel"}, 
      React.createElement("div", {className: "modal-dialog ", role: "document"}, 
        React.createElement("div", {className: "modal-content"}, 
          React.createElement("div", {className: "modal-header"}, 
            React.createElement("button", {type: "button", className: "close", "data-dismiss": "modal", "aria-label": "Close"}, React.createElement("span", {"aria-hidden": "true"}, "×")), 
            React.createElement("h1", {className: "modal-title", id: "myModalLabel"}, self.state.data.Title)
          ), 
          React.createElement("div", {className: "modal-body"}, 
          React.createElement("div", {className: "row"}, 
            React.createElement("div", {className: "col-md-4"}, 
              React.createElement("img", {id: "imgs", src: self.state.data.Poster})
            ), 
            React.createElement("div", {className: "col-md-8"}, 
                React.createElement("h4", null, "Year: ", self.state.arr.Year), 
                React.createElement("p", null, "Actors: ", self.state.arr.Actors), 
                React.createElement("p", null, "Director: ", self.state.arr.Director), 
                React.createElement("p", null, "Plot: ", self.state.arr.Plot), 
                React.createElement("p", null, "Released: ", self.state.arr.Released), 
                React.createElement("p", null, "Awards: ", self.state.arr.Awards), 
                React.createElement("p", null, "Rated: ", self.state.arr.Rated), 
                React.createElement("p", null, "Genre: ", self.state.arr.Genre), 
                React.createElement("button", {onClick: (event)=>{self.insert(self.state.arr)}, className: "btn btn-success btn-lg"}, "Add"), 
                React.createElement("p", {id: "success"}, self.state.success)
            )
          )

          ), 
          React.createElement("div", {className: "modal-footer"}, 
              React.createElement("button", {className: "btn btn-danger", "data-dismiss": "modal"}, "Close")
        )
        )
      )
    )
      ...
      movList.map(function(d){
       ...
       return(React.createElement("div", {className: "well row", key: count++}, 
        React.createElement("div", {className: "col-sm-4"}, React.createElement("img", {id: "imgs", src: d.Poster})), 
       React.createElement("div", {className: "col-sm-8"}, React.createElement("h2", null, " ", d.Title), React.createElement("h3", null, "Year: ", d.Year), 
       React.createElement("button", {onClick: (event)=>{self.handleView(d)}, className: "btn btn-success gap", "data-toggle": "modal", 
       "data-target": "#myModalAdd1"}, 
       "View"
       ), React.createElement("br", null), 
       React.createElement("div", {className: "modal fade", id: "myModalAdd1", role: "dialog", "aria-labelledby": "myModalLabel"}, 
 React.createElement("div", {className: "modal-dialog ", role: "document"}, 
   React.createElement("div", {className: "modal-content"}, 
     React.createElement("div", {className: "modal-header"}, 
       React.createElement("button", {type: "button", className: "close", "data-dismiss": "modal", "aria-label": "Close"}, React.createElement("span", {"aria-hidden": "true"}, "×")), 
       React.createElement("h1", {className: "modal-title", id: "myModalLabel"}, self.state.arr.Title)
     ), 
     React.createElement("div", {className: "modal-body"}, 
     React.createElement("div", {className: "row"}, 
       React.createElement("div", {className: "col-md-4"}, 
         React.createElement("img", {id: "imgs", src: self.state.arr.Poster})
       ), 
       React.createElement("div", {className: "col-md-8"}, 
           React.createElement("h4", null, "Year: ", self.state.arr.Year), 
           React.createElement("p", null, "Actors: ", self.state.arr.Actors), 
           ...
           React.createElement("p", null, "Rated: ", self.state.arr.Rated), 
           React.createElement("p", null, "Genre: ", self.state.arr.Genre), 
           React.createElement("p", null, "Language: ", self.state.arr.Language), 
           React.createElement("p", null, "Writer: ", self.state.arr.Writer)
           )
     )
     ), 
     React.createElement("div", {className: "modal-footer"}, 
 ...
 React.createElement("button", {onClick: (event)=>{self.handleView(d)}, className: "btn btn-warning gap", "data-toggle": "modal", 
 "data-target": "#myModalAdd2"}, 
 "Update"
 ), React.createElement("br", null), 
       React.createElement("div", {className: "modal fade", id: "myModalAdd2", role: "dialog", "aria-labelledby": "myModalLabel"}, 
 React.createElement("div", {className: "modal-dialog ", role: "document"}, 
   React.createElement("div", {className: "modal-content"}, 
     React.createElement("div", {className: "modal-header"}, 
       React.createElement("button", {type: "button", className: "close", "data-dismiss": "modal", "aria-label": "Close"}, React.createElement("span", {"aria-hidden": "true"}, "×")), 
     ...
     React.createElement("div", {className: "row"}, 
       ...
       React.createElement("div", {className: "col-md-8"}, 
           ...
           React.createElement("p", null, "Rated: ", self.state.arr.Rated), 
           React.createElement("p", null, "Genre: ", self.state.arr.Genre), 
           React.createElement("h4", null, "Rate this Movie"), 
           ...
           React.createElement("button", {onClick: (event)=>{self.update(self.state.arr,self.state.rate)}, className: "btn btn-success btn-lg"}, "Update"), 
           React.createElement("p", {id: "success"}, self.state.success)
       )
     )
 ...
 React.createElement("button", {className: "btn btn-danger gap", onClick: (event)=>{self.handleDelete(d)}}, 
 "Delete"
 ), React.createElement("br", null)
       )
       ))
...
Router.run(routes, Router.HistoryLocation, function(Root){
  React.render(React.createElement(Root, null), document.getElementById('heading'));
});
},{"./routes.js":204,"react":199,"react-dom":10,"react-router":35}],203:[function(require,module,exports){
var React = require('react');
var Router = require('react-router');
...
},{"react":199,"react-router":35}],204:[function(require,module,exports){
var React = require('react');
var Router = require('react-router');
...
React.createElement(Route, null, 
        React.createElement(Route, {handler: Master}, 
           React.createElement(DefaultRoute, {handler: Head, name: "Home"})
        )
)
);
},{"./components/Head":200,"./pages/Master/Master":203,"react":199,"react-router":35}]},{},[202]);
